...
AH5_PUBLIC char AH5_read_els_planewave (hid_t file_id, const char *path,
                                        AH5_planewave_t *planewave);
AH5_PUBLIC char AH5_read_els_sphericalwave (hid_t file_id, const char *path,
    AH5_sphericalwave_t *sphericalwave);
AH5_PUBLIC char AH5_read_els_generator (hid_t file_id, const char *path,
                                        AH5_generator_t *generator);
...
AH5_PUBLIC char AH5_read_els_sourceonmesh (hid_t file_id, const char *path,
    AH5_sourceonmesh_t *sourceonmesh);
