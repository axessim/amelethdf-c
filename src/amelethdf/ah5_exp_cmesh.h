 ...
 **/
AH5_PUBLIC char AH5_init_intersection(AH5_intersection_t *inter, AH5_intersection_type_t type,
                                      AH5_index_t i, AH5_index_t j, AH5_index_t k, char normal, AH5_index_t polygon_id);
 ...
 **/
AH5_PUBLIC char AH5_init_conform_group(AH5_cgroup_t *group, const char *path, const char *type,
                                       const char *entitytype, hsize_t nb_groupelts, const AH5_index_t *groupelts);
