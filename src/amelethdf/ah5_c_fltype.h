...
AH5_PUBLIC char AH5_read_ft_singlereal (hid_t file_id, const char *path,
                                        AH5_singlereal_t *singlereal);
AH5_PUBLIC char AH5_read_ft_singlecomplex (hid_t file_id, const char *path,
    AH5_singlecomplex_t *singlecomplex);
AH5_PUBLIC char AH5_read_ft_singlestring (hid_t file_id, const char *path,
    AH5_singlestring_t *singlestring);
AH5_PUBLIC char AH5_read_ft_vector (hid_t file_id, const char *path, AH5_vector_t *vector);
AH5_PUBLIC char AH5_read_ft_linearlistofreal1 (hid_t file_id, const char *path,
    AH5_linearlistofreal1_t *linearlistofreal1);
AH5_PUBLIC char AH5_read_ft_linearlistofreal2 (hid_t file_id, const char *path,
    AH5_linearlistofreal2_t *linearlistofreal2);
AH5_PUBLIC char AH5_read_ft_logarithmlistofreal (hid_t file_id, const char *path,
    AH5_logarithmlistofreal_t *logarithmlistofreal);
AH5_PUBLIC char AH5_read_ft_perdecadelistofreal (hid_t file_id, const char *path,
    AH5_perdecadelistofreal_t *perdecadelistofreal);
AH5_PUBLIC char AH5_read_ft_linearlistofinteger2 (hid_t file_id, const char *path,
    AH5_linearlistofinteger2_t *linearlistofinteger2);
AH5_PUBLIC char AH5_read_ft_rationalfunction (hid_t file_id, const char *path,
    AH5_rationalfunction_t *rationalfunction);
AH5_PUBLIC char AH5_read_ft_generalrationalfunction (hid_t file_id, const char *path,
    AH5_generalrationalfunction_t *generalrationalfunction);
...
AH5_PUBLIC char AH5_write_ft_linearlistofreal1 (hid_t file_id,
    AH5_linearlistofreal1_t *linearlistofreal1);
AH5_PUBLIC char AH5_write_ft_linearlistofreal2 (hid_t file_id,
    AH5_linearlistofreal2_t *linearlistofreal2);
AH5_PUBLIC char AH5_write_ft_logarithmlistofreal (hid_t file_id,
    AH5_logarithmlistofreal_t *logarithmlistofreal);
AH5_PUBLIC char AH5_write_ft_perdecadelistofreal (hid_t file_id,
    AH5_perdecadelistofreal_t *perdecadelistofreal);
AH5_PUBLIC char AH5_write_ft_linearlistofinteger2 (hid_t file_id,
    AH5_linearlistofinteger2_t *linearlistofinteger2);
AH5_PUBLIC char AH5_write_ft_rationalfunction (hid_t file_id,
    AH5_rationalfunction_t *rationalfunction);
AH5_PUBLIC char AH5_write_ft_generalrationalfunction (hid_t file_id,
    AH5_generalrationalfunction_t *generalrationalfunction);
...
AH5_PUBLIC void AH5_print_ft_linearlistofreal1 (const AH5_linearlistofreal1_t *linearlistofreal1,
    int space);
AH5_PUBLIC void AH5_print_ft_linearlistofreal2 (const AH5_linearlistofreal2_t *linearlistofreal2,
    int space);
AH5_PUBLIC void AH5_print_ft_logarithmlistofreal (const AH5_logarithmlistofreal_t
    *logarithmlistofreal, int space);
AH5_PUBLIC void AH5_print_ft_perdecadelistofreal (const AH5_perdecadelistofreal_t
    *perdecadelistofreal, int space);
AH5_PUBLIC void AH5_print_ft_linearlistofinteger2 (const AH5_linearlistofinteger2_t
    *linearlistofinteger2, int space);
AH5_PUBLIC void AH5_print_ft_rationalfunction (const AH5_rationalfunction_t *rationalfunction,
    int space);
AH5_PUBLIC void AH5_print_ft_generalrationalfunction (const AH5_generalrationalfunction_t
...
AH5_PUBLIC void AH5_free_ft_generalrationalfunction (AH5_generalrationalfunction_t
    *generalrationalfunction);
